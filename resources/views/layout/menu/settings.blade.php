<aside class="menu">
	...
	@can('edit-company-settings')
		...
		<ul class="menu-list">
			<li>
				<a href="{{ route('settings.company.profile') }}" class="{{ setActive('instellingen/bedrijf/profiel') }}">
					Profiel
				</a>
			</li>

			<li>
				<a href="{{ route('settings.company.location') }}" class="{{ setActive('instellingen/bedrijf/locatie') }}">
					Locatie
				</a>
			</li>

			<li>
				<a href="{{ route('settings.company.administration') }}" class="{{ setActive('instellingen/bedrijf/administratie') }}">
					Administratie
				</a>
			</li>
		</ul>
	...
	<ul class="menu-list">
		...
		@can('edit-permission-settings')
			<li>
				<a href="{{ route('settings.rights.permission') }}" class="{{ setActive('instellingen/bedrijf/permissie') }}">
					Permissies
				</a>
			</li>
		@endcan
